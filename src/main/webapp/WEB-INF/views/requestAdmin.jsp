...
<div class="flex-container">
    ...
    <form:form class="row g-3 needs-validation" method="post" modelAttribute="request" novalidate="true">
        ...
        <div>
            <label class="form-label"><b>Previous Company Details-1:</b></label>
        </div>
        <div>
        ...
        <div>
            ...
            <form:label path="adress1" type="text" class="form-control" id="adress1"  name="adress1" required="required">${request.adress1}</form:label>
        </div>

        <div>
            <label class="form-label"><b>Previous Company Details-2:</b></label>
        </div>
        <div>
        ...
        <div>
            ...
            <form:label path="adress2" type="text" class="form-control" id="adress2"  name="adress2" required="required">${request.adress2}</form:label>
        </div>


        <div>
            <label class="form-label"><b>Educational Details:</b></label>
        </div>
        ...
        <div>
            <label class="form-label"><b>New Status:</b></label>
        </div>
